    ...
    def add_prediction_op(self):
        ...
        if self.model_type == "LSTMsepsimpcomp":
            with tf.variable_scope("treeLSTM"):
                Wi = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMWi:0")
                bi = tf.Variable(tf.zeros([1,self.config.state_size]) + 1e-3, name = "LSTMbi:0")
                Wf = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMWf:0")
                bf = tf.Variable(tf.zeros([1,self.config.state_size]) + 1, name = "LSTMbf:0")
                Wo = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMWo:0")
                bo = tf.Variable(tf.zeros([1,self.config.state_size]) + 1e-3, name = "LSTMbo:0")
                Wu = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMWu:0")
                bu = tf.Variable(tf.zeros([1,self.config.state_size]) + 1e-3, name = "LSTMbu:0")
                Ui1 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUi1:0")
                Ui2 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUi2:0")
                Uo1 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUo1:0")
                Uo2 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUo2:0")
                Uu1 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUu1:0")
                Uu2 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUu2:0")
                Uf11 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMf11:0")
                Uf12 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUf12:0")
                Uf21 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUf21:0")
                Uf22 = tf.Variable(initer([self.config.state_size,self.config.state_size]), name = "LSTMUf22:0")
