...
class PIModel(object):
    ...
    def add_prediction_op(self):
        ...
        if self.model_type == "sepcomp":
            ...
            psubjectNP = self.combine([subjecta, subjectn],"comp")
            pobjectNP = self.combine([objecta, objectn],"comp")
            pVP = self.combine([adverb, verb],"comp")
            pobjectDP1 = self.combine([objectd, objectNP],"comp")
            pobjectDP2 = self.combine([objectDP1, VP],"comp")
            pnegobjectDP = self.combine([neg, objectDP2],"comp")
            pfinal = self.combine([subjectd, subjectNP,],"comp")
            pfinal2 = self.combine([final, negobjectDP],"comp")
            ...
            hsubjectNP = self.combine([subjecta, subjectn],"comp2")
            hobjectNP = self.combine([objecta, objectn],"comp2")
            hVP = self.combine([adverb, verb],"comp2")
            hobjectDP1 = self.combine([objectd, objectNP],"comp2")
            hobjectDP2 = self.combine([objectDP1, VP],"comp2")
            hnegobjectDP = self.combine([neg, objectDP2],"comp2")
            hfinal = self.combine([subjectd, subjectNP,],"comp2")
            hfinal2 = self.combine([final, negobjectDP],"comp2")
