                                            ...
                                            for prem, prem_len, hyp, hyp_len, label in train_data:
                                                ...
                                                if count*config.batch_size % 100000< config.batch_size:
                                                    ...
                                                    if ratio(preds_val, labels_val) > best_val:
                                                        ...
                                                        save_path = saver.save(sess, os.path.join(model+attention,os.path.join(results_folder, "bestmodel.ckpt")))
...
if __name__ == '__main__':
    hyperparameter_search([ ("simpcomp", "no"),("sepsimpcomp", "no"), ("siamese", "no"),("seq2seq","no"),("seq2seq","wordbyword")], "training_data/dummy", [0.001, 0.0003,0.0001], [0, 0.0001, 0.001], [1.0, 0.9, 0.8], ["tanh", "relu"], [100], [100], [64], 30)
