...
for prefix in prefixes:
    with open(os.path.join(prefix + "gendata", prefix + "gendata.train"), "r") as f:
        examples1 = []
        examples2 = []
        examples5 = []
        examples6 = []
        for line in f.readlines():
            ...
            examples6.append(example6)
    random.shuffle(examples1)
    random.shuffle(examples2)
    random.shuffle(examples5)
    random.shuffle(examples6)
    with open(os.path.join(prefix + "gendata", prefix + "gendata.train" + "1"), 'w') as f:
        for example in examples1:
            f.write(json.dumps(example)+ "\n")
    with open(os.path.join(prefix + "gendata", prefix + "gendata.train" + "2"), 'w') as f:
        for example in examples2:
            f.write(json.dumps(example)+ "\n")
    with open(os.path.join(prefix + "gendata", prefix + "gendata.train" + "5"), 'w') as f:
        for example in examples5:
            f.write(json.dumps(example)+ "\n")
    with open(os.path.join(prefix + "gendata", prefix + "gendata.train" + "6"), 'w') as f:
        for example in examples6:
            f.write(json.dumps(example)+ "\n")
