...
if __name__ == '__main__':
    ...
    if False:
        fol.build_simple_file("boolean_solutions")
    ...
    examples = gd.generate_balanced_data("simple_solutions", "boolean_solutions", 100, 100, data,simple_sampling = "level 0", boolean_sampling = "level 0")
