...
while True:
    premise = data_util.parse_sentence(data,input("Enter a premise sentence:\n"))
    while premise == None:
        premise = data_util.parse_sentence(data,input("There was some issue with the entered premise\n Enter a premise sentence:\n"))
    hypothesis = data_util.parse_sentence(data,input("Enter a hypothesis sentence:\n"))
    while hypothesis == None:
        hypothesis = data_util.parse_sentence(data,input("There was some issue with the entered premise\n Enter a premise sentence:\n"))
    if len(premise) == 1:
